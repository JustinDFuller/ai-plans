function App() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-remix-dark to-remix-darker text-white font-sans">
      ...
      <nav className="fixed top-0 w-full bg-remix-dark/60 backdrop-blur-md z-50 border-b border-remix-gray-800/50">
        <div className="max-w-7xl mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            <div className="font-black text-2xl bg-gradient-to-r from-remix-blue to-purple-400 bg-clip-text text-transparent">
              AI Plans
            </div>
      ...
      <section className="relative px-6 pt-40 pb-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="max-w-5xl">
            ...
            <p className="mt-8 text-2xl md:text-3xl lg:text-4xl font-light text-gray-200 leading-relaxed max-w-4xl">
            ...
            <div className="mt-12 flex flex-wrap items-center gap-4">
              <a
                ...
                className="group relative px-8 py-4 bg-gradient-to-r from-remix-blue to-purple-600 rounded-lg font-bold text-lg hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-remix-blue/50"
              >
              ...
              <a 
                href="#example" 
                className="px-8 py-4 border-2 border-remix-gray-700 rounded-lg font-bold text-lg hover:border-remix-blue hover:text-remix-blue transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-remix-blue/20"
              >
                View Example
              </a>
            </div>
      ...
      {/* What are AI Plans? */}
      <section id="what" className="px-6 py-32 relative">
          ...
          <div className="max-w-4xl">
            ...
            <div className="space-y-6 text-lg md:text-xl text-gray-300 leading-relaxed">
              ...
              <div className="grid gap-6 mt-12">
                <div className="group flex items-start gap-6 p-6 bg-gradient-to-br from-remix-gray-900/50 to-remix-gray-900/30 rounded-xl border border-remix-gray-800 hover:border-remix-blue/50 transition-all duration-300 hover:shadow-lg hover:shadow-remix-blue/10">
                  <div className="text-4xl group-hover:scale-110 transition-transform duration-300">📝</div>
                  <div>
                    <div className="font-bold text-xl mb-2 text-white">Original Request</div>
                    <div className="text-gray-400">Capture the exact developer request or problem statement</div>
                  </div>
                </div>
                <div className="group flex items-start gap-6 p-6 bg-gradient-to-br from-remix-gray-900/50 to-remix-gray-900/30 rounded-xl border border-remix-gray-800 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10">
                  <div className="text-4xl group-hover:scale-110 transition-transform duration-300">🎯</div>
                  <div>
                    <div className="font-bold text-xl mb-2 text-white">Implementation Plan</div>
                    <div className="text-gray-400">Document the AI's proposed approach and architecture</div>
                  </div>
                </div>
                <div className="group flex items-start gap-6 p-6 bg-gradient-to-br from-remix-gray-900/50 to-remix-gray-900/30 rounded-xl border border-remix-gray-800 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10">
                  <div className="text-4xl group-hover:scale-110 transition-transform duration-300">✅</div>
                  <div>
                    <div className="font-bold text-xl mb-2 text-white">Task Tracking</div>
                    <div className="text-gray-400">Track TODOs with completion status throughout execution</div>
                  </div>
                </div>
                <div className="group flex items-start gap-6 p-6 bg-gradient-to-br from-remix-gray-900/50 to-remix-gray-900/30 rounded-xl border border-remix-gray-800 hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10">
                  <div className="text-4xl group-hover:scale-110 transition-transform duration-300">🔧</div>
                  <div>
                    <div className="font-bold text-xl mb-2 text-white">Issue Resolution</div>
                    <div className="text-gray-400">Document problems encountered and their solutions</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="px-6 py-32 relative">
        ...
        <div className="relative max-w-7xl mx-auto">
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-black mb-16 text-center tracking-tight">
            <span className="text-remix-blue">AI Plans</span>{' '}
            <span className="text-gray-500">vs</span>{' '}
            <span className="text-purple-400">ADRs</span>
          </h2>
          <div className="overflow-hidden rounded-2xl border border-remix-gray-800 bg-remix-gray-900/50 backdrop-blur-sm">
      ...
      {/* File Format */}
      <section id="format" className="px-6 py-32">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-black mb-16 tracking-tight">
            File <span className="text-remix-yellow">Format</span>
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="group">
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-gray-200">Naming Convention</h3>
              <div className="bg-remix-gray-900/80 rounded-xl p-8 border border-remix-gray-800 group-hover:border-remix-blue/50 transition-all duration-300 hover:shadow-xl hover:shadow-remix-blue/10">
                <code className="text-green-400 text-lg md:text-xl font-mono">
            ...
            <div className="group">
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-gray-200">Required Sections</h3>
      ...
      {/* Example */}
      <section id="example" className="px-6 py-32 relative">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="bg-remix-gray-950 rounded-2xl border border-remix-gray-800 overflow-hidden shadow-2xl">
            ...
            <pre className="p-8 overflow-x-auto">
              <code className="text-gray-300 font-mono text-sm md:text-base leading-relaxed">{`# Add User Authentication System
...
*Tool: Claude Code (claude.ai/code)*`}</code>
      ...
      <section className="px-6 py-32">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="group p-8 bg-gradient-to-br from-remix-blue/10 via-remix-gray-900/50 to-transparent rounded-2xl border border-remix-gray-800 hover:border-remix-blue/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-remix-blue/20">
              <div className="text-5xl mb-6 group-hover:scale-110 transition-transform duration-300">🔍</div>
              <h3 className="font-bold text-xl mb-3 text-white">Searchable History</h3>
              <p className="text-gray-400">Find how similar problems were solved</p>
            </div>
            <div className="group p-8 bg-gradient-to-br from-purple-600/10 via-remix-gray-900/50 to-transparent rounded-2xl border border-remix-gray-800 hover:border-purple-500/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/20">
              <div className="text-5xl mb-6 group-hover:scale-110 transition-transform duration-300">🎯</div>
              <h3 className="font-bold text-xl mb-3 text-white">Context Preservation</h3>
              <p className="text-gray-400">Keep full context of decisions</p>
            </div>
            <div className="group p-8 bg-gradient-to-br from-blue-600/10 via-remix-gray-900/50 to-transparent rounded-2xl border border-remix-gray-800 hover:border-blue-500/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20">
              <div className="text-5xl mb-6 group-hover:scale-110 transition-transform duration-300">👥</div>
              <h3 className="font-bold text-xl mb-3 text-white">Team Knowledge</h3>
              <p className="text-gray-400">Share AI patterns across team</p>
            </div>
            <div className="group p-8 bg-gradient-to-br from-green-600/10 via-remix-gray-900/50 to-transparent rounded-2xl border border-remix-gray-800 hover:border-green-500/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-green-500/20">
              <div className="text-5xl mb-6 group-hover:scale-110 transition-transform duration-300">📈</div>
              <h3 className="font-bold text-xl mb-3 text-white">Process Improvement</h3>
              <p className="text-gray-400">Refine AI usage over time</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Getting Started */}
      <section id="getting-started" className="px-6 py-32 relative">
            ...
            {[
              ...
              <div key={item.num} className="flex gap-8">
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 bg-gradient-to-br from-remix-blue to-purple-600 rounded-2xl flex items-center justify-center font-black text-2xl shadow-lg shadow-remix-blue/30">
                    {item.num}
                  </div>
                </div>
                <div className="flex-1">
                  ...
                  {item.content && (
                    <div className="bg-remix-gray-900/80 rounded-xl p-6 border border-remix-gray-800 hover:border-remix-blue/50 transition-all duration-300">
                      {item.content}
                    </div>
                  )}
                </div>
